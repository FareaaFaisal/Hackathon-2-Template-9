    ...
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-6">
      ...
      <div >
        ...
        <div className="mt-6 lg:mt-10 flex items-center gap-4">
          <img src="/Watch.svg" alt="watch" className="w-[48px] lg:w-[78px]" />
          <div>
            <p>Opening Hours</p>
      ...
      <div>
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-4">
            <img src="/Mask Group.svg" alt="post" className="w-[48px] lg:w-[59px]" />
            <div>
          ...
          <div className="flex items-center gap-4">
            <img src="/Mask Group (2).svg" alt="post" className="w-[48px] lg:w-[59px]" />
            <div>
              <p className="text-sm lg:text-base text-gray-400">20 Feb 2024</p>
              <p className="text-sm lg:text-base">Keep Your Business</p>
            </div>
          ...
          <div className="flex items-center gap-4">
            <img src="/unsplash_50KffXbjIOg.svg" alt="post" className="w-[48px] lg:w-[59px]" />
            <div>
              <p className="text-sm lg:text-base text-gray-400">20 Feb 2024</p>
              <p className="text-sm lg:text-base">Keep Your Business</p>
            </div>
